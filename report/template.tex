...
\begin{titlepage}
	...
	\center
	\textsc{\LARGE $entity$}\\[1.5cm]
	\textsc{\Large $service$}\\[0.5cm]
	\textsc{\large $context$}\\[0.5cm]

	\HRule\\[0.4cm]
	{\huge\bfseries $title$}\\[0.4cm]
	\HRule\\[1.5cm]

	\textsc{\large $subject_title$}\\[0.5cm]
	$subject$
	\vfill
	...
	\begin{minipage}{0.4\textwidth}
		\begin{flushright}
			\large
			\textit{$supervisor1_title$}\\
			$supervisor1$\\[1cm]
			\textit{$supervisor2_title$}\\
			$supervisor2$
		\end{flushright}
	\end{minipage}
